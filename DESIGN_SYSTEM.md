...
- Use a single gains baseline in public copy: `1+ heure/jour par collaborateur` (= `20+ h/mois`, `100+ h/mois pour une équipe de 5`). Do not mix granular gains by assistant if they can add up incoherently. Source of truth: `07-sales/GAINS-REFERENCE.md`.
